#!/usr/bin/env python3
"""
Простой скрипт для добавления тестовых данных материалов без PIL
"""
...
def add_test_products():
    ...
    try:
        ...
        # Реальные материалы с сайта Inox Metal Art (без изображений)
        test_products = [
            {
        ...
        db.commit()
        print(f"✅ Успешно добавлено {len(test_products)} материалов с сайта Inox Metal Art!")
...
if __name__ == "__main__":
    print("🚀 Добавляем материалы с сайта Inox Metal Art...")
    add_test_products()
    print("✨ Готово!")
